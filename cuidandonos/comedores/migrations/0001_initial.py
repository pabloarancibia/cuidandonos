# Generated by Django 3.1 on 2020-08-18 03:48
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('personeria', models.CharField(blank=True, max_length=60)),
                ('cuitPersoneria', models.IntegerField(blank=True)),
                ...
                ('tipoRemuneracionDS', models.CharField(blank=True, max_length=60)),
                ...
                ('tipoDeporte', models.CharField(blank=True, max_length=60)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nombreInst', models.CharField(blank=True, max_length=80)),
                ('direcInst', models.CharField(blank=True, max_length=80)),
                ('contactoInst', models.CharField(blank=True, max_length=80)),
                ('contactoDom', models.CharField(blank=True, max_length=80)),
                ('nombreClinica', models.CharField(blank=True, max_length=80)),
                ('direcClinica', models.CharField(blank=True, max_length=80)),
                ('contactoClinica', models.CharField(blank=True, max_length=80)),
                ('contactoFamiliar', models.CharField(blank=True, max_length=80)),
